...
-- Brain AI (Iracore) | Heart AI (health) | System AI (Code/AI)
-- ============================================================================
...
-- ============================================================================
-- SEED DATA: Brain AI Nodes (Iracore - Standalone)
-- ============================================================================
...
INSERT INTO ai_nodes (id, ai_type, name, description, keywords, priority) VALUES
  ...
  ('brain-engineering', 'brain', 'Engineering', 'Engineering calculations, design, analysis', ARRAY['engineering', 'calculate', 'design', 'mechanical', 'electrical', 'structural', 'thermal', 'fluid'], 95),
  ('brain-creative', 'brain', 'Creative & Writing', 'Creative writing, blueprints, documentation', ARRAY['write', 'create', 'blueprint', 'document', 'draft', 'compose', 'generate', 'story'], 90),
  ('brain-analysis', 'brain', 'Analysis & Research', 'Data analysis, research, insights', ARRAY['analyze', 'research', 'compare', 'evaluate', 'assess', 'study', 'investigate'], 85),
  ('brain-technical', 'brain', 'Technical Support', 'Technical explanations and troubleshooting', ARRAY['technical', 'troubleshoot', 'debug', 'solve', 'fix', 'issue', 'problem'], 80)
